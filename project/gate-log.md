# gate-log — pilot: gumon-hp
形式: {gate, 判定, 根拠資料参照, 実行者コンテキストID, 日時, 使用Framework版}
- {QG0, pass, artifacts/brief.json(未確定3件は仮置き+リスク注記の形式で充足), cowork-session/wdos-quality-gate相当, 2026-07-03, v1.0.0-rc.1}
- {QG1, pass, artifacts/brand.json(5軸全根拠引用・語彙10+反語彙10・禁忌4・ユーザー承認取得), 人間承認+cowork-session, 2026-07-03, v1.0.0-rc.1}
